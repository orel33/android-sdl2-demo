...
After that, you should access from you PATH to the following commands: `java,
android, ndk-build, ant, emulator, adb`.
...
* AndroidManifest.xml: The high-level description of your Android
  application (label, icon, orientation, activity, ...).
* build.xml: The main build file for your Android application (used by
...
Host GPU (unless OpenGL ES could fail). See the configuration snapshot of your AVD below.

![Emuator configuration.](lib/exe/fetch.php?media=projtec:avd.png)
